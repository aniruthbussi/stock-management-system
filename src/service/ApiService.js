...
export default class ApiService {
    ...
    static ENCRYPTION_KEY = "aniruth-inventory";
    ...
    static async addProduct(fromData){
        const response = await axios.post(`${this.BASE_URL}/products/add`, fromData, {
            headers: {
                ...this.getHeader(),
    ...
    static async updateProduct(formData) {
        return axios.put(`${this.BASE_URL}/products/update`, formData, {
          headers: {
            ...this.getHeader(),
            "Content-Type": "multipart/form-data",
          },
    ...
    static async getTransactionsByMonthAndYear(month, year) {
        const response = await axios.get(`${this.BASE_URL}/transactions/by-month-and-year`, {
            headers: this.getHeader(),
            params: {
                month:month,
                year:year
    ...
    static async getTransactionById(transactionId, filter) {
